...
function App() {
  ...
  function validarCardNumber(number){
    ...
    if (onlyNumbers && number!==''&& number.length>=16){
    ...
    if (cardAdded){
      ...
      <form className="CardForm" onSubmit={validarSubmit}>
            <label htmlFor='cardholderName'>CARDHOLDER NAME
              ...
              {errorName && <small>Can't be blank and must contain at least 2 letters</small>}
            </label>
            <label htmlFor='cardNumber'>CARD NUMBER
              ...
              {errorCardNumber && <small>Wrong format, numbers only or must contain at least 16 numbers.</small>}
            </label>
            <div className="GoupForm">
                <label htmlFor='month'>EXP. DATE (MM/YY)
                    ...
                    {errorDate && <small>Can't be blank and only numbers</small>}
                </label>
                <label htmlFor='cvc'>CVC
                    ...
                    {errorCvc && <small>Can't be blank and only numbers</small>}
                </label>
            </div>
